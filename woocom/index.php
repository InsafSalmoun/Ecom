...
<body>
	<?php  
		$orders = file_get_contents('http://localhost/woocom/orders.php');
		$orders = json_decode($orders, true);
		$customers = file_get_contents('http://localhost/woocom/customers.php');
		$customers = json_decode($customers, true);
		$products = file_get_contents('http://localhost/woocom/products.php');
